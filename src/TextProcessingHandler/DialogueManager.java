...
//////////////////////////////////////
					...
					}else Answer = "Maaf kami tidak memiliki produk yang anda minta detail nya";
//////////////////////////////////////
...
//////////////////////////////////////				
				}else if(text.getClassificationId()== 5){ //biaya Pengiriman
					String purchaselogId = 	dc.getUserActivePurchaseLog(text.getConversationId());
	...
	int createSearcList(String message){
		...
		for (String keyword : keywords){
			...
			for(int i=0;i<2;i++){
				...
				ArrayList<Integer> result = dc.getItemId(st.stem(keyword),i);
				 for(int id : result){
					 int additional=0;
					 if(i == 0) //nama
						 additional = 25;
				 ...
				 System.out.println("isi map : "+map.toString());				
			} 
		}
		//sort map
		int count = 0;
